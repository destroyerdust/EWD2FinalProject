...
<body>
  ...
  <div class="row testimonial">
    <div class="small-12 large-9 columns">
      <h1>FAQ</h1>
      <h4>What's the difference between the $20 helmet and the $100 one?</h4>
      <p>Generally more expensive helmets are lighter, with more sophisticated retention systems that are more adjustable, offer better ventilation with a more and larger vents and have more stylish appearance. Additionally the more expensive helmet's outer shell
      ...
      <p>"Is a higher TPI better?" It depends on what you want or need. If you are a competitive athlete who wants speed regardless of the cost, then the answer is an unqualified "YES". Generally a tire with a soft, thin, tread compound and super high TPI will
        stick like crazy in the corners and accelerate like a rocket, but there is a downside. Thin light tires usually will not last very long. If you are a rider on a budget then the answer is probably "no". A cheaper tire with lower TPI and a thicker tread
